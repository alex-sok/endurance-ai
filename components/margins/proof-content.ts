// The evidence tier for /margins/proof. This is the document the landing page
// links to: the full ledger, the mechanism in detail, and the method.
//
// It carries the long-form chapters that used to sit on /margins itself. Same
// claims discipline: every figure except the finance hours is drawn from the
// source brokerage's production system on August 24, 2026, and the hours stay
// labeled as the team's own estimate. The brokerage is never named.

import { DEMO_HREF, type MarginsCta } from "./content";
...
export const PROOF_HERO = {
  kicker: "Margins · The record",
  title: "Margins in production.",
  lede: "The long version, for anyone who wants to check the work. Every figure, the mechanism behind it, and the limits of what it proves.",
  back: { label: "Back to Margins", href: "/margins" },
};
...
export const LEDGER = {
  ...
  rows: [
    ...
    {
      label: "Duplicate loads stopped before payment",
      qualifier: "about $5,491 that would have paid twice",
      figure: "20",
    },
    { label: "Configuration changes filed and reviewed", figure: "343" },
    {
      label: "Finance hours returned each week",
      qualifier: "the team's estimate rather than a queried figure",
      figure: "30 to 40",
    },
  ] as LedgerRow[],
