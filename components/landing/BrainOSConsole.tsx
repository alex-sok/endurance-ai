 ...
 *
 * The same component runs embedded on the landing page and full screen at
 * /brain-os, where the industries move to a rail down the side because there
 * is room for them to stay visible.
 */
...
export function BrainOSConsole({ variant = "embedded" }: { variant?: "embedded" | "full" }) {
  ...
  return (
    <div className={full ? "bpos-full" : undefined}>
