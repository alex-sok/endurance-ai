...
const faqs = [
  {
    ...
    a: "Depends on scope. The AI Audit is one engagement — you have a prioritized roadmap within a week. The Embedded AI Engineer tiers run 2 weeks, 2 months, or 6 months. We deliberately scope work into defined deliverables rather than open-ended retainers.",
  },
  {
  ...
  },
  {
    ...
    a: "It means we work inside your organization — in your Slack, your standups, your codebase — not at arm's length producing deliverables. The work moves faster because we're not waiting on weekly status calls to understand what's changed.",
  },
  {
    q: "We're in a regulated industry. Does that change what you can do?",
    a: "No. We've built production AI systems inside pharmaceuticals, financial services, healthcare, and insurance. We understand that regulated environments can't 'move fast and break things.' We build within compliance constraints without sacrificing the quality of the outcome.",
  },
  {
  ...
  },
  {
    ...
    a: "Fixed-scope engagements at flat fees — no hourly billing, no open-ended retainers unless you want them. The AI Audit is $999. Embedded AI Engineer engagements range from $19K to $179K depending on scope and timeline. We scope the work, price it, and deliver it.",
  },
];
