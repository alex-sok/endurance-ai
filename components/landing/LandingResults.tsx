...
export function LandingResults({ onOpenChat }: Props) {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        gsap.from("[data-results-header]", {
          autoAlpha: 0,
          y: 24,
          duration: 0.9,
          ease: "power3.out",
          scrollTrigger: { trigger: "[data-results-header]", start: "top 85%" },
        });
        ...
        gsap.from("[data-results-nda]", {
          autoAlpha: 0,
          duration: 0.9,
          scrollTrigger: { trigger: "[data-results-nda]", start: "top 92%" },
        });
      });
    }, ref);
  ...
  return (
    <section ref={ref} className="py-28 md:py-40" aria-label="Field results">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        <div data-results-header className="mb-16 md:mb-24">
        ...
        >
          <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-bone/55 max-w-sm leading-relaxed">
