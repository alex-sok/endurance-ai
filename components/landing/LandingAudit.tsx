    ...
    <section ref={ref} className="py-28 md:py-40" aria-label="The AI Audit">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div
          ...
          style={{ background: "#f7f7f4", color: "#262510", borderRadius: 4 }}
        >
          <div className="lg:col-span-7">
            <p className="font-mono text-[11px] uppercase tracking-[0.32em] mb-8" style={{ color: "#5f5e57" }}>
              Start Here
            </p>
            <h2
            ...
            <div className="space-y-5 text-[15px] leading-relaxed max-w-xl" style={{ color: "rgba(38,37,16,0.70)" }}>
              <p>
            ...
            <p className="mt-10 font-mono text-[11px] uppercase tracking-[0.22em]" style={{ color: "#5f5e57" }}>
          ...
          <div className="lg:col-span-5">
            <div
              ...
              style={{ border: "1px solid rgba(38,37,16,0.15)", borderRadius: 4 }}
            >
              <p className="font-mono text-[11px] uppercase tracking-[0.25em] mb-6" style={{ color: "#5f5e57" }}>
                The AI Audit
              </p>
              <p
                data-audit-price
              ...
              <p className="font-mono text-[11px] uppercase tracking-[0.18em] mb-8" style={{ color: "#5f5e57" }}>
                Flat fee. One engagement. No retainer.
              </p>

              <ul className="space-y-3.5 mb-8">
                {BULLETS.map((b) => (
                  <li key={b} className="flex gap-3 text-sm leading-relaxed" style={{ color: "rgba(38,37,16,0.75)" }}>
                    <span className="mt-px shrink-0" style={{ color: "#f54e00" }} aria-hidden>
                      ✦
                    </span>
                    {b}
                  </li>
              ...
              <p className="text-xs mb-8" style={{ color: "#5f5e57" }}>
              ...
              <a
                ...
                style={{ background: "#262510", color: "#f7f7f4", borderRadius: 4 }}
              >
                Book an AI Audit →
              </a>
            </div>
