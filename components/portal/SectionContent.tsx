...
export function SectionContent({ section, portal }: Props) {
  ...
  if ((portal.slug === "rjs-briefing" || portal.slug.startsWith("rjs")) && section.slug === "overview") {
  ...
  if (portal.slug.startsWith("franmore") && section.slug === "overview") {
    return <FrankieDeliverable />;
  }
